...
public interface IReservaRepositorio extends IGenericoRepositorio <Reserva,Integer>{
    ...
    @Query(value= "Insert into reservas_mascotas_habitaciones (fecha_entrada,fecha_salida,precioR,id_mascota,id_habitacion) values (:fecha_entrada,:fecha_salida,:precio,:id_mascota,:id_habitacion)" ,nativeQuery = true)
    ...
    @Query(value = "Update reservas_mascotas_habitaciones, SET (fecha_entrada ,fecha_salida , precioR ,id_mascota ,id_habitacion ) values(:fechaEntrada,  :fechaSalida,   :precio, :idMascota,  :idHabitacion) WHERE id_reserva = :idReserva",nativeQuery = true)
