...
public interface IMascotaRepositorio extends IGenericoRepositorio <Mascota,Integer>{
    ...
    public Integer inserta1 (@Param("edad") int edad,@Param("nombre") String nombre,@Param("raza")String raza,@Param("tamano")String tamano,@Param("tipo_habitacion")String tipo_habitacion,@Param("id_cliente")int idCliente);
